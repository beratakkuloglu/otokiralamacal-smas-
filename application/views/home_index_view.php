        ...
        <div class="container">
            <div class="row">
                ...
                <a class="btn btn-link text-light" href="home">Ana Sayfa</a>
                    <a class="btn btn-link text-light" href="home/vehicle">
                        Araçlar</a>
                    <a class="btn btn-link text-light" href="home/rezervation">
                        Rezervasyonlarım</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <p>Hoşgeldiniz.</p>
                <p>
                    Artık Sakarya ya herhangi bir nedenle geldiğinizde
                    aracınız hazır!
                </p>
                <p>
                    Bunun için sistemize giriş yapıp sitemiz üzerinden
                    herhangi bir ön ücret ödemeksizin aracınızı
                    ayırtabilir ve geldiğinizde de aracınızı teslim alıp
